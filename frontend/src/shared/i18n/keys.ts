...
export const HOME_I18N_KEYS = {
  hero: {
    ...
    suggestionLabel: "hero.suggestion_label",
    suggestion1: "hero.suggestions.0",
    suggestion2: "hero.suggestions.1",
    suggestion3: "hero.suggestions.2",
    suggestion4: "hero.suggestions.3",
    trustDoctors: "hero.trust_doctors",
    trustBookings: "hero.trust_bookings",
    trustSupport: "hero.trust_support",
    filterAll: "hero.filter_all",
    filterDoctor: "hero.filter_doctor",
    filterClinic: "hero.filter_clinic",
    filterSpecialty: "hero.filter_specialty",
    groupSpecialties: "hero.group_specialties",
    groupClinics: "hero.group_clinics",
    groupDoctors: "hero.group_doctors",
    searchNoResults: "hero.search_no_results",
    searchPleaseType: "hero.search_please_type",
  },
  clinics: {
    title: "clinics.title",
    desc: "clinics.desc",
